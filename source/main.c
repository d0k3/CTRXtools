...
MenuInfo menu[] =
{
    ...
    },
    {
        "File Dump... (EmuNAND1)", 10, // ID 11
        {
            ...
            { "Dump updtsave.bin",            &DumpFile,             N_EMUNAND1 | F_UPDATESAVE }
        }
    },
    {
        "File Dump... (EmuNAND2)", 10, // ID 12
        {
            ...
            { "Dump updtsave.bin",            &DumpFile,             N_EMUNAND2 | F_UPDATESAVE }
        }
    },
    {
        "File Dump... (EmuNAND3)", 10, // ID 13
        {
            ...
            { "Dump updtsave.bin",            &DumpFile,             N_EMUNAND3 | F_UPDATESAVE }
        }
    },
    {
        "File Dump... (EmuNAND4)", 10, // ID 14
        {
            ...
            { "Dump updtsave.bin",            &DumpFile,             N_EMUNAND4 | F_UPDATESAVE }
        }
    },
    {
        "File Inject... (SysNAND)", 9, // ID 15
        {
    ...
    },
    {
        "File Inject... (EmuNAND1)", 10, // ID 16
        {
            ...
            { "Inject updtsave.bin",          &InjectFile,           N_NANDWRITE | N_EMUNAND1 | F_UPDATESAVE }
        }
    },
    {
        "File Inject... (EmuNAND2)", 10, // ID 17
        {
            ...
            { "Inject updtsave.bin",          &InjectFile,           N_NANDWRITE | N_EMUNAND2 | F_UPDATESAVE }
        }
    },
    {
        "File Inject... (EmuNAND3)", 10, // ID 18
        {
            ...
            { "Inject updtsave.bin",          &InjectFile,           N_NANDWRITE | N_EMUNAND3 | F_UPDATESAVE }
        }
    },
    {
        "File Inject... (EmuNAND4)", 10, // ID 19
        {
            ...
            { "Inject updtsave.bin",          &InjectFile,           N_NANDWRITE | N_EMUNAND4 | F_UPDATESAVE }
        }
    },
    {
